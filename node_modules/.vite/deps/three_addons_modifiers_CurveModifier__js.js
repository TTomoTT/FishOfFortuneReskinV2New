import { Bn as HalfFloatType, Ea as RGBAFormat, Pr as LinearFilter, Qn as InstancedMesh, Ut as DataUtils, Vt as DataTexture, _o as RepeatWrapping, an as DynamicDrawUsage, ii as Mesh, ni as Matrix4 } from "./three.module-Dhi4sXJn.js";
//#region node_modules/three/examples/jsm/modifiers/CurveModifier.js
var CHANNELS = 4;
...
function initSplineTexture(numberOfCurves = 1) {
	const dataTexture = new DataTexture(new Uint16Array(TEXTURE_WIDTH * TEXTURE_HEIGHT * numberOfCurves * CHANNELS), TEXTURE_WIDTH, TEXTURE_HEIGHT * numberOfCurves, RGBAFormat, HalfFloatType);
	...
	*/
	constructor(mesh, numberOfCurves = 1) {
		...
		obj3D.traverse(function(child) {
			if (child instanceof Mesh || child instanceof InstancedMesh) if (Array.isArray(child.material)) {
				const materials = [];
...
//#endregion
export { Flow, InstancedFlow };

//# sourceMappingURL=three_addons_modifiers_CurveModifier__js.js.map